...
/* Commands and HID Report ID for USB 52XX  */
...
typedef struct t_file_header {
  ...
  __u8 start_time[6];  // Time logging started of type date_struct
} file_header;
...
void usbReadFile_USB52XX(int fd, __u8 ack_count, char *filename);
