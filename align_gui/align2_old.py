"""
script to develope code for solving met5 alighment values
...
z<1darray>  Vector lenght M Measured variables(data points) or terms
...
before 11/25/12:
fairly sure align2.py came from align.py
align.py came from met5_plot_sens<int>.py series
'''
import numpy
import math
import ompysys
...
class Align(object):
    """
    Class to create and manage  and methods for solving for
    MET5 system alignment ajustments.
    """
    def __init__(self):
        allterms,weights,usedperts,sens_filename,\
        trialfilename,sens_filenames,force = _start()
    ...
    def set_A(self,fields_arg=None):
        ...
        If fields_arg = None sets attb self.A
    ...
    def make_z_from_GntSet(self,gs):
        ...
        Inputs:
        gs<GntSet> Gnts croped to ca ready to have fitzern run
                    gs.original2 list of feild anmes feild_#
        allterms<list> of strings of names of row terms ie. field_0_z9
        """
        #fields<dict> scenario fields data from read_cv_file()
        allterms = self.allterms
        #colum<str> name of colum in Luc's spreed sheet exp: scenario2
...
#    print 'sens_filename     ' ,sens_filename
    ...
    allterms, weights =  zip(*[
                 ...
                 ('ztrans_obj - ztrans_ret',0),
                 ])

    return allterms,weights,usedperts,sens_filename,trialfilename,sens_filenames,force
