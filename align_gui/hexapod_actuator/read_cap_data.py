"""
Module has function to read cap gauges of pob
Reads POB cap gauges records data in file ./cap_gauge_data/drift_data/chan_
read_cap_data. record_avg_positions_drift_after_move(monitorIntervalInSec, totalMonitorTimeInHour)
(int) monitorIntervalInSec
(int) totalMonitorTimeInHour
"""
