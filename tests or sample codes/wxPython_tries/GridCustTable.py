...
class TestFrame(wx.Frame):
    def __init__(self, parent, log):
        ...
        bs.Add(b)
        p.SetSizer(bs)
        #grid.SetCellValue(3, 0, repr(999))
        #print grid.GetCellValue(2,0)
        grid.GetTable().SetValue(3,0,999)
        print type(grid.GetTable().GetValue(3,0))
        print type(grid.GetCellValue(3,0))
